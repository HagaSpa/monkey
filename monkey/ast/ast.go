...
// LetStatement is Statement Node
...
// ReturnStatement is Statement Node
...
/*
ExpressionStatement is Statement Node. e.g..
    let x = 5;
...
type InfixExpression struct {
	Token    token.Token // 中置トークン. 二項演算子(binary expression)
	Left     Expression
	Operator string // +, -, *, /, ==, !=
	Right    Expression
}
